<?php
	...
	if (!$_SESSION['login']) {
		...
		header("Location: ".$dirname."../../login.php?redirect=Onboarding/Database Schema/index.php");
	}
?>
<!DOCTYPE html>
...
<head>
  ...
  <link rel="canonical" href="https://affinsys.com/Onboarding/Database%20Schema/">
  ...
  <script>
    ...
    var mkdocs_page_input_path = "Onboarding/Database Schema.md";
    var mkdocs_page_url = "/Onboarding/Database%20Schema/";
  </script>
