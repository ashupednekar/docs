<?php
	...
	if (!$_SESSION['login']) {
		...
		header("Location: ".$dirname."../../login.php?redirect=Onboarding/Use Cases/index.php");
	}
?>
<!DOCTYPE html>
...
<head>
  ...
  <link rel="canonical" href="https://affinsys.com/Onboarding/Use%20Cases/">
  <link rel="shortcut icon" href="../../img/favicon.ico">
  <title>Use Cases - amigo-auth</title>
  ...
  <script>
    ...
    var mkdocs_page_input_path = "Onboarding/Use Cases.md";
    var mkdocs_page_url = "/Onboarding/Use%20Cases/";
  </script>
...
<body class="wy-body-for-nav" role="document">
  ...
  <hr/>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="../../Payment/Database%20Schema/" class="btn btn-neutral float-right" title="Database Schema">Next <span class="icon icon-circle-arrow-right"></span></a>
  ...
  <span class="rst-current-version" data-toggle="rst-current-version">
      ...
      <span><a href="../../Payment/Database%20Schema/" style="color: #fcfcfc">Next &raquo;</a></span>
