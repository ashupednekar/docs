<?php
	...
	if (!$_SESSION['login']) {
		...
		header("Location: ".$dirname."../../login.php?redirect=Onboarding/Data Flow/index.php");
	}
?>
<!DOCTYPE html>
...
<head>
  ...
  <link rel="canonical" href="https://affinsys.com/Onboarding/Data%20Flow/">
  ...
  <script>
    ...
    var mkdocs_page_input_path = "Onboarding/Data Flow.md";
    var mkdocs_page_url = "/Onboarding/Data%20Flow/";
  </script>
