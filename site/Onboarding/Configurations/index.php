<?php
	...
	if (!$_SESSION['login']) {
		...
		header("Location: ".$dirname."../../login.php?redirect=Onboarding/Configurations/index.php");
	}
?>
<!DOCTYPE html>
...
<head>
  ...
  <link rel="canonical" href="https://affinsys.com/Onboarding/Configurations/">
  ...
  <script>
    ...
    var mkdocs_page_input_path = "Onboarding/Configurations.md";
    var mkdocs_page_url = "/Onboarding/Configurations/";
  </script>
...
<body class="wy-body-for-nav" role="document">
  ...
  <hr/>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="../../MFA/Use%20Cases/" class="btn btn-neutral" title="Use Cases"><span class="icon icon-circle-arrow-left"></span> Previous</a>
  ...
  <span class="rst-current-version" data-toggle="rst-current-version">
      ...
      <span><a href="../../MFA/Use%20Cases/" style="color: #fcfcfc">&laquo; Previous</a></span>
