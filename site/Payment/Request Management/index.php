<?php
	...
	if (!$_SESSION['login']) {
		...
		header("Location: ".$dirname."../../login.php?redirect=Payment/Request Management/index.php");
	}
?>
<!DOCTYPE html>
...
<head>
  ...
  <link rel="canonical" href="https://affinsys.com/Payment/Request%20Management/">
  <link rel="shortcut icon" href="../../img/favicon.ico">
  <title>Request Management - amigo-auth</title>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "Request Management";
    var mkdocs_page_input_path = "Payment/Request Management.md";
    var mkdocs_page_url = "/Payment/Request%20Management/";
  </script>
...
<body class="wy-body-for-nav" role="document">
  ...
  <form id ="rtd-search-form" class="wy-form" action="../../search.php" method="get">
      ...
      <div class="wy-menu wy-menu-vertical" data-spy="affix" role="navigation" aria-label="main navigation">
                ...
                <ul class="current">
                    ...
                    <li class="toctree-l1 current"><a class="reference internal current" href="./">Request Management</a>
                    </li>
                    <li class="toctree-l1"><a class="reference internal" href="../Settlement/">Settlement</a>
                    </li>
                </ul>
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <p><img alt="invoice image" src="https://i.ibb.co/FnqXtWv/bigstock-online-invoices-payment-101026874-removebg-preview.png" /></p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="../Settlement/" class="btn btn-neutral float-right" title="Settlement">Next <span class="icon icon-circle-arrow-right"></span></a>
  ...
  <span class="rst-current-version" data-toggle="rst-current-version">
      ...
      <span><a href="../Settlement/" style="color: #fcfcfc">Next &raquo;</a></span>
