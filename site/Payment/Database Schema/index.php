<?php
	...
	if (!$_SESSION['login']) {
		...
		header("Location: ".$dirname."../../login.php?redirect=Payment/Database Schema/index.php");
	}
?>
<!DOCTYPE html>
...
<head>
  ...
  <link rel="canonical" href="https://affinsys.com/Payment/Database%20Schema/">
  ...
  <script>
    ...
    var mkdocs_page_input_path = "Payment/Database Schema.md";
    var mkdocs_page_url = "/Payment/Database%20Schema/";
  </script>
...
<body class="wy-body-for-nav" role="document">
  ...
  <hr/>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="../../Onboarding/Use%20Cases/" class="btn btn-neutral" title="Use Cases"><span class="icon icon-circle-arrow-left"></span> Previous</a>
  ...
  <span class="rst-current-version" data-toggle="rst-current-version">
      ...
      <span><a href="../../Onboarding/Use%20Cases/" style="color: #fcfcfc">&laquo; Previous</a></span>
