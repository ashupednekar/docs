<?php
	...
	if (!$_SESSION['login']) {
		...
		header("Location: ".$dirname."../login.php?redirect=source/index.php");
	}
?>
<!DOCTYPE html>
...
<head>
  ...
  <link rel="canonical" href="https://affinsys.com/source/">
  <link rel="shortcut icon" href="../img/favicon.ico">
  <title>Index - amigo-auth</title>
  ...
  <script>
    ...
    var mkdocs_page_input_path = "source/index.md";
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <p>.. auth documentation master file, created by
   sphinx-quickstart on Thu Jul 15 01:40:14 2021.
   You can adapt this file completely to your liking, but it should at least
   contain the root <code>toctree</code> directive.</p>
<h1 id="welcome-to-auths-documentation">Welcome to auth's documentation!</h1>
<p>.. toctree::
   :maxdepth: 2
   :caption: Contents:</p>
<h1 id="indices-and-tables">Indices and tables</h1>
<ul>
<li>:ref:<code>genindex</code></li>
...
<li>:ref:<code>search</code></li>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="../Wallet/Use%20Cases/" class="btn btn-neutral" title="Use Cases"><span class="icon icon-circle-arrow-left"></span> Previous</a>
  ...
  <span class="rst-current-version" data-toggle="rst-current-version">
      ...
      <span><a href="../Wallet/Use%20Cases/" style="color: #fcfcfc">&laquo; Previous</a></span>
