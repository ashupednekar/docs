<?php
	...
	if (!$_SESSION['login']) {
		...
		header("Location: ".$dirname."../../login.php?redirect=Auth/Use Cases/index.php");
	}
?>
<!DOCTYPE html>
...
<head>
  ...
  <link rel="canonical" href="https://affinsys.com/Auth/Use%20Cases/">
  ...
  <script>
    ...
    var mkdocs_page_input_path = "Auth/Use Cases.md";
    var mkdocs_page_url = "/Auth/Use%20Cases/";
  </script>
...
<body class="wy-body-for-nav" role="document">
  ...
  <hr/>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="../../Core/Why%20amigo-auth/" class="btn btn-neutral float-right" title="Why amigo auth">Next <span class="icon icon-circle-arrow-right"></span></a>
  ...
  <span class="rst-current-version" data-toggle="rst-current-version">
      ...
      <span><a href="../../Core/Why%20amigo-auth/" style="color: #fcfcfc">Next &raquo;</a></span>
